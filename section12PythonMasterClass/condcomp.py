...
# meals = [meal for meal in menu if "spam" not in meal if "chicken" not in meal]  its also valid
...
# ("bacon" in meal and "sausage" in meal) check if meal contains bacon an sausage,
print(fussy_meals)
